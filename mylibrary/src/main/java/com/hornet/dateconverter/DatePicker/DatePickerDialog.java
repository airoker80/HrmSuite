...
public class DatePickerDialog extends DialogFragment implements View.OnClickListener, DatePickerController {
    ...
    private HashSet<OnDateChangedListenerNep> mListeners = new HashSet<>();
     ...
     */
    public interface OnDateChangedListenerNep {
    ...
    private void updatePickers() {
        ...
        for (OnDateChangedListenerNep listener : mListeners) listener.onDateChanged();
    }
    ...
    @Override
    public void registerOnDateChangedListener(OnDateChangedListenerNep listener) {
        mListeners.add(listener);
    }

    @Override
    public void unregisterOnDateChangedListener(OnDateChangedListenerNep listener) {
