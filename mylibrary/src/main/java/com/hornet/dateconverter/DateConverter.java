...
public class DateConverter {
    ...
    public DateConverter() {
        ...
        daysInMonthMap.put(2091, new int[]{0, 31, 31, 32, 31, 31, 31, 30, 30, 29, 30, 30, 30});
        daysInMonthMap.put(2092, new int[]{0, 30, 31, 32, 32, 31, 30, 30, 30, 29, 30, 30, 30});
        daysInMonthMap.put(2093, new int[]{0, 30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30});
        daysInMonthMap.put(2094, new int[]{0, 31, 31, 32, 31, 31, 30, 30, 30, 29, 30, 30, 30});
        daysInMonthMap.put(2095, new int[]{0, 31, 31, 32, 31, 31, 31, 30, 29, 30, 30, 30, 30});
        daysInMonthMap.put(2096, new int[]{0, 30, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30});
        daysInMonthMap.put(2097, new int[]{0, 31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30});
        daysInMonthMap.put(2098, new int[]{0, 31, 31, 32, 31, 31, 31, 29, 30, 29, 30, 29, 31});
        daysInMonthMap.put(2099, new int[]{0, 31, 31, 32, 31, 31, 31, 30, 29, 29, 30, 30, 30});
        daysInMonthMap.put(2100, new int[]{0, 31, 32, 31, 32, 30, 31, 30, 29, 30, 29, 30, 30});
        ...
        startWeekDayMonthMap.put(2091, new int[]{0, 6, 2, 5, 2, 5, 1, 4, 6, 1, 2, 4, 6});
        startWeekDayMonthMap.put(2092, new int[]{0, 1, 3, 6, 3, 7, 3, 5, 7, 2, 3, 5, 7});
        startWeekDayMonthMap.put(2093, new int[]{0, 2, 4, 1, 4, 1, 4, 6, 1, 3, 4, 6, 1});
        startWeekDayMonthMap.put(2094, new int[]{0, 3, 6, 2, 6, 2, 5, 7, 2, 4, 5, 7, 2});
        startWeekDayMonthMap.put(2095, new int[]{0, 4, 7, 3, 7, 3, 6, 2, 4, 5, 7, 2, 4});
        startWeekDayMonthMap.put(2096, new int[]{0, 6, 1, 4, 1, 5, 1, 3, 5, 6, 1, 2, 4});
        startWeekDayMonthMap.put(2097, new int[]{0, 6, 2, 6, 2, 6, 2, 4, 6, 1, 2, 4, 6});
        startWeekDayMonthMap.put(2098, new int[]{0, 1, 4, 7, 4, 7, 3, 6, 7, 2, 3, 5, 6});
        startWeekDayMonthMap.put(2099, new int[]{0, 2, 5, 1, 5, 1, 4, 7, 2, 3, 4, 6, 1});
        startWeekDayMonthMap.put(2100, new int[]{0, 3, 6, 3, 6, 3, 5, 1, 3, 4, 6, 7, 2});
    ...
    public static boolean isEngDateInRange(int yy, int mm, int dd) {return (yy >= 1944 && yy <= 2043) && (mm >= 1 && mm <= 12) && (dd >= 1 && dd <= 31);}

    /*check if nepali date is in the range of conversion*/
    public static boolean isNepDateInRange(int yy, int mm, int dd) {return (yy >= 2000 && yy <= 2100) && (mm >= 1 && mm <= 12) && (dd >= 1 && dd <= 32);}
